...
ggplot(data = df_melted, aes(x = variable, y = value)) + geom_col(colour = "black",fill = "greenyellow") + facet_wrap(~status) + ggtitle("Прибыль по нескольким товарам \n во всех магазинах")+ylab('Прибыль, руб')+xlab('Товары')
